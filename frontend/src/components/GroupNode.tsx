...
export const GroupNode = memo(function GroupNode({ data, id, selected }: NodeProps) {
  ...
  const { onPreviewFrame, onRename, onDelete, onUngroup } = nodeData
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-warning/20 bg-warning/5 rounded-t-xl">
      ...
      <div className="flex items-center gap-2 p-3">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/50 text-xs text-text transition-opacity">First</div>
        </button>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/50 text-xs text-text transition-opacity">Last</div>
        </button>
      </div>
